...
## Funktioner
- Skapa, editera och ta bort "att göra" objekt.
- Sätta prioritet på de olika "att göra" objekten.
- Lägga till datum och ha påminnelser.
- Organisera "att göra" objekt efter taggar/kategorier.
- Kunna samarbeta med andra användare på listor av "att göra" objekt. 

## Installation
1. Installera [MongoDB Community Server](https://www.mongodb.com/try/download/community) 

2. Klona repot via [Git Bash](https://git-scm.com/downloads) eller klona repot via [Github](https://github.com/):
```
Git Bash:
